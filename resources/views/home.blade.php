...
<div class="min-h-full">
    <nav class="bg-custom" x-data="{ isOpen: false }">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-20    items-center justify-between">
          <div class="flex items-center">
            <div class="flex-shrink-0">
                <img class="h-43 w-43" src="{{ asset('img/logo.svg') }}" alt="Your Company">
            </div>
            <div class="hidden md:flex justify-center">
                <div class="ml-40 flex items-baseline space-x-5" x-data="{ isOpen: false }">
                  ...
                  <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Koleksi</a>
                  <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Forum</a>
                </div>
              </div>
    ...
    <header class="bg-white shadow  h-screen">
